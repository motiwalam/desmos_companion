/*
  this was taken from https://github.com/rgov/node-shlex , a node.js port of
  python's shlex library, which provides exactly the sort of parsing I want to
  use for parsing macro input. since it is a node module, I thought the easiest
  method is to just copy the Shlexer class over here
